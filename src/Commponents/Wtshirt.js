...
import wtshirt1 from '../Images/Women/wtshit1.webp'
import wtshirt2 from '../Images/Women/wtshit2.webp'
import wtshirt3 from '../Images/Women/wtshit3.webp'
...
function Wtshirt() {
    ...
    const handleClick = () => {
        ...
        const itemDetails = {
            name: "Studiofit White Textured T-Shirt",
            description: "Step into a textured delight with Studiofit's white chevron-patterned t-shirt",
            price: "599",
            image: wtshirt1,
            size: selectedSize 
        };
        ...
        <div>
            ...
            <Row>
                ...
                <Col md={4} xs={12}>
                    <Carousel>
                        <Carousel.Item interval={1600}>
                            <img src={wtshirt1} style={{ width: "100%" }} />
                        </Carousel.Item>
                        <Carousel.Item interval={1600}>
                            <img src={wtshirt2} style={{ width: "100%" }} />
                        </Carousel.Item>
                        <Carousel.Item interval={1600}>
                            <img src={wtshirt3} style={{ width: "100%" }} />
                        </Carousel.Item>
                    </Carousel><hr />
                ...
                <Col md={4} xs={12}>
                    <Card style={{ width: '100%' }}>
                        <Card.Body>
                            <Card.Title>Studiofit White Textured T-Shirt</Card.Title>
                            <Card.Subtitle className="mb-2 text-muted">Step into a textured delight with Studiofit's white chevron-patterned t-shirt</Card.Subtitle><hr />
                            ...
                            <Card.Text>
                                ...
                                <p>Description: T-Shirt<br/><br/>
                                    Dimensions: 67cm<br/><br/>
                                    Step into a textured delight with Studiofit's white chevron-patterned t-shirt, combining a relaxed fit, short sleeve and V-neck.<br/><br/>
                                    Net Quantity: 1N<br/><br/>
                                    Fit: Regular Fit<br/><br/>
                                    Care Instruction: Machine Wash<br/><br/>
                                    Fabric Composition: Cotton Poly Lycra<br/><br/>
                                    Model Fit: The model is 5.7" and wearing a size M<br/><br/>
